...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39685974225165584)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39686261364165584)
,p_plug_template_id=>wwv_flow_api.id(39685974225165584)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39686575708165584)
,p_plug_template_id=>wwv_flow_api.id(39685974225165584)
,p_name=>'Slides'
