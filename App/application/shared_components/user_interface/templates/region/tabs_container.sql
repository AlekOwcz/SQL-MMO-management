...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39719508878165599)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39719847014165600)
,p_plug_template_id=>wwv_flow_api.id(39719508878165599)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39720131223165600)
,p_plug_template_id=>wwv_flow_api.id(39719508878165599)
,p_name=>'Tabs'
