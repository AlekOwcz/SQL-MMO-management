...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39682715964165583)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39683023914165583)
,p_plug_template_id=>wwv_flow_api.id(39682715964165583)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39683301438165583)
,p_plug_template_id=>wwv_flow_api.id(39682715964165583)
,p_name=>'Sub Regions'
