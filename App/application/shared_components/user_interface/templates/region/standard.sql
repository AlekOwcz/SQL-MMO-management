...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39712737261165596)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39713023307165597)
,p_plug_template_id=>wwv_flow_api.id(39712737261165596)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39713319388165597)
,p_plug_template_id=>wwv_flow_api.id(39712737261165596)
,p_name=>'Sub Regions'
