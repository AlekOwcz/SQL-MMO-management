...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(39693164659165587)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39693466420165587)
,p_plug_template_id=>wwv_flow_api.id(39693164659165587)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(39693793433165588)
,p_plug_template_id=>wwv_flow_api.id(39693164659165587)
,p_name=>'Sub Regions'
